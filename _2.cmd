...
for %%e in (*.png) do (
"%PROGRAMFILES%\ImageMagick-6.7.9-Q16\convert.exe" "%%~ne.png" -flatten -crop 224x1080+0x0 +dither -colors 5 temp.png
set file=%%~ne_RG
...
"%PROGRAMFILES%\ImageMagick-6.7.9-Q16\convert.exe"  "temp.png"  -format %%c histogram:info:hist.txt
